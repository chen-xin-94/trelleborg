...
filename = Path("C:\\LINHC\\VersucheDBs\\Trelleborg\\2020-11-02_Dauerlauf_LEM2_dropna.pkl")
...
speed1 = data["Ist-MG15: Durchschnittsgeschw.1[mm/s]"]
speed2 = data["Ist-MG16: Durchschnittsgeschw.2[mm/s]"]
...
cplot((s11[-10000:,20]),".", label=f"S11 LEM{lem_tag} Nov 02")
cplot((s22[-10000:,20]),".", label=f"S22 LEM{lem_tag} Nov 02")
cplot((s21[-10000:,20]),".", label=f"S21 LEM{lem_tag} Nov 02")
plt.legend(loc=0)
plt.grid(1)
plt.title("500MHz")
...
raise Exception()
idx1 = np.arange(20000,21000, dtype=int)
