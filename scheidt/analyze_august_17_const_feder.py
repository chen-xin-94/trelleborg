...
filename = Path("C:\\LINHC\\VersucheDBs\\Trelleborg\\2020-08-17_Konstantdruck_merge_resampled_80ms_dropna.pkl")
...
ax1.plot(pos1[idx1],abs(s21_1[idx1,f_idx]),label=f"Kammer 1 {p_idx1:.1f}bar 0.1Hz")
ax1.plot(pos2[idx1],abs(s21_2[idx1,f_idx]),label=f"Kammer 2 {p_idx1:.1f}bar 0.1Hz")
ax2.plot(pos1[idx2],abs(s21_1[idx2,f_idx]),label=f"Kammer 1 {p_idx2:.1f}bar 0.1Hz")
ax2.plot(pos2[idx2],abs(s21_2[idx2,f_idx]),label=f"Kammer 2 {p_idx2:.1f}bar 0.1Hz")
ax1.set_ylabel("Abs(S21)")
ax1.legend(loc=0)
...
plt.figure(f"Signal S21 @{f_MHz}MHz vs Pos1/2 Kammer 1")
ax1 = plt.subplot(2,1,1)
plt.title(f"Signal S21 @{f_MHz}MHz vs Pos1/2 Kammer 2")
ax2 = plt.subplot(2,1,2, sharex=ax1)
ax1.plot(pos1[6000:7000],abs(s21_1[6000:7000]),label="Kammer 1 180bar 0.1Hz")
ax2.plot(pos1[6000:7000],abs(s21_2[6000:7000]),label="Kammer 2 180bar 0.1Hz")
ax1.plot(pos1[60000:61000],abs(s21_1[60000:61000]),label="Kammer 1 0bar 0.1Hz")
ax2.plot(pos1[60000:61000],abs(s21_2[60000:61000]),label="Kammer 2 0bar 0.1Hz")
ax1.set_ylabel("Abs(S21)")
ax1.legend(loc=0)
ax2.set_xlabel("Pos1/2 (mm)")
ax2.set_ylabel("Abs(S21)")
...
ax1.plot(pos1[6000:7000],abs(s21_1[6000:7000]),label="Kammer 1 180bar 0.1Hz WF")
ax1.plot(pos1[6000:7000],abs(s21_2[6000:7000]),label="Kammer 2 180bar 0.1Hz WF")
ax1.set_ylabel("Abs(S21)")
ax1.legend(loc=0)
...
ax1 = plt.subplot(1,1,1)
ax1.plot(s21_1[10000:12000].real,s21_1[10000:12000].imag,".",label="Kammer 1 180 bar 0.1Hz WF")
ax1.plot(s21_2[10000:12000].real,s21_2[10000:12000].imag,".",label="Kammer 2 180 bar 0.1Hz WF")
